 ...
 * Slug: blockera/columns-with-images
 * Categories: featured
...
<div class="wp-block-columns alignwide">
	...
	<p class="has-text-align-center"><?php echo esc_html_x( 'Sample content. Replace the text with your own content.', 'sample content', 'blockera' ); ?></p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:column -->
	<!-- wp:column -->
